...
{% include figure.html src="/assets/images/figure_monitoring.png" caption="<strong>Figure .</strong> A systematic framework for peatland restoration monitoring, highlighting the integration of pre-restoration (baseline) and post-restoration phases within an adaptive management cycle, generated by Gemini (Google) on April 30 2026." %}
